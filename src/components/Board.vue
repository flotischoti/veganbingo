...
.container {
  max-width: calc(
    (100vh - $nav-bar-height - $title-height-0 - $footer-height-0)
  );
  margin: 0 auto;
  overflow: hidden;
  ...
  @media (min-width: $bp3) and (min-height: calc($bp3 + $nav-bar-height + $title-height-2 + $footer-height-3)) {
    max-width: calc(
      (100vh - $nav-bar-height - $title-height-2 - $footer-height-3)
    );
  }

  @media (min-width: $bp4) and (min-height: calc($bp4 + $nav-bar-height + $title-height-4 + $footer-height-3)) {
    max-width: calc(
      (100vh - $nav-bar-height - $title-height-4 - $footer-height-3)
    );
  }

  @media (min-width: $bp5) and (min-height: calc($bp5 + $nav-bar-height + $title-height-6 + $footer-height-3)) {
    max-width: calc(
      (100vh - $nav-bar-height - $title-height-6 - $footer-height-3)
    );
  }
      ...
      .actions {
        ...
        button {
          ...
          -webkit-tap-highlight-color: rgba(
            ...
            0,
            0
          ); // For stupid Safari/Chrome to avoid blue highlight
...
@keyframes glow {
  from {
    text-shadow: 0 0 5px #fff, 0 0 10px #fff, 0 0 15px #e6bc00, 0 0 20px #e6bc00,
      0 0 25px #e6bc00, 0 0 30px #e6bc00, 0 0 35px #e6bc00;
  }

  to {
    text-shadow: 0 0 10px #fff, 0 0 15px #fff34d, 0 0 20px #fff34d,
      0 0 25px #fff34d, 0 0 30px #fff34d, 0 0 35px #fff34d, 0 0 40px #ff4da6;
  }
}
</style>
